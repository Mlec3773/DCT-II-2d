module dct2_1d_2#(parameter WIDTH = 16
)(input signed [0:511]X_test,
input [1:0]N,
...
wire signed [WIDTH+6:0] Y2E_shifted[0:1], Y2O_shifted[0:1], Y4O_shifted[0:3], Y8O_shifted[0:7], Y16O_shifted[0:15];
genvar i;
