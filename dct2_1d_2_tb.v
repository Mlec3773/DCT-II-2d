...
dct2_1d_1 #(16) DUV(.X_test(X_test), .N(N), .Y(Y) );
...
initial begin // carrega os vetores de teste no início da simulação
	$readmemb("/home/cklein/stage/TSMC_TCBN65GPHPBWPWC/Marco_files/DIGITAL/DCT-II-2d/verif/simple_tb/input1d2.dat", testvectors); // lê vetores na memória
